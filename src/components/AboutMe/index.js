...
const AboutMe = () => {
    return (
      <Fragment>
        ...
        <p>
          My name is Alex. I graduated from University of Oregon in 2016, with Bachelor Degree majoring in Computer Science and Japanese Study. As extension to my studies, I enjoy building web applications with open source libraries, as well as reading Japanese novels as my hobby.
        </p>
        <p>
